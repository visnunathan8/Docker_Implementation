...
if rank == 0:
    ...
    print(f'Most canceled flights : {Counter(results).most_common()[0][0]}')
    ...
    Canceled_Flights = df[(df.Cancelled == True) & (df['FlightDate'] > "2021-08-31") & (df['FlightDate'] < "2021-10-01")]
    comm.send(Canceled_Flights["Airline"].values.tolist(), dest=0)
